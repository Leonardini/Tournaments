...
- `make_chunks10.R` — splits McKay's order-10 catalogue (`data/mckay/tournaments10.txt`,
  fetched by `./get_data.sh n10` from the repo root) into the `chunk_%03d.RData`
  files `solve_ilp10.R` reads (streamed, constant memory).
